...
> 有研究显示在保持速度的前提下，步频的微妙增加可以大大减轻跑步时髋关节和膝关节的负荷，并可能有助于预防和治疗与跑步相关的常见伤害。（+5%，+10%均显著）
[REF](https://journals.lww.com/acsm-msse/fulltext/2011/02000/effects_of_step_rate_manipulation_on_joint.14.aspx)


> 一项研究调查了在短时间内将步数提高到每分钟180步，是否可以提高训练有素的女性跑步者的跑步经济性。 参与者被分为实验组和对照组，实验组接受为期10天的训练计划。 结果表明，与对照组相比，实验组在两种测试速度下，氧气消耗量明显降低，平均减少11.0%。 这种改善与更高的步进频率、更短的步长和较低的心率有关。 研究结果表明，增加步进节奏的训练可以有效地提高运行经济性。
[REF](https://journals.lww.com/nsca-jscr/fulltext/2021/09000/step_frequency_training_improves_running_economy.23.aspx)
